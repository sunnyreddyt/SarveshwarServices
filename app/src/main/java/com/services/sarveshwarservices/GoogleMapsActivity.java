...
import com.services.sarveshwarservices.service.FetchAddressIntentService;
import com.services.sarveshwarservices.utils.ABUtil;
import com.services.sarveshwarservices.utils.AppUtils;
import com.services.sarveshwarservices.utils.Circle;
import com.services.sarveshwarservices.utils.ShapeRipple;
...
public class GoogleMapsActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener {
    ...
    int isResultCode = 0;
    RelativeLayout goLayout, listLayout;
    Shared shared;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        listLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(GoogleMapsActivity.this, LocationsListActivity.class);
        ...
        goLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mLocationText.getText().toString().length() > 0) {
                    ...
                    LocationsDB locationsDB = new LocationsDB(GoogleMapsActivity.this);
                    ...
                    if (shared.getCurrentLocation().length() > 0 && shared.getCustomerLatitude().length() > 0 && shared.getCustomerLongitude().length() > 0) {
                        ...
                        Toast.makeText(GoogleMapsActivity.this, "Added Successfully", Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(GoogleMapsActivity.this, "Unable to get address for this location, Please try again", Toast.LENGTH_SHORT).show();
                    }
    ...
    public void init() {
        ...
        mContext = GoogleMapsActivity.this;
        abUtil = ABUtil.getInstance(GoogleMapsActivity.this);
        shared = new Shared(GoogleMapsActivity.this);
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        if (mLastLocation != null) {
            ...
            try {
                LocationServices.FusedLocationApi.removeLocationUpdates(mGoogleApiClient, GoogleMapsActivity.this);
    ...
    private void startIntentService(Location mLocation) {
        ...
        Intent intent = new Intent(GoogleMapsActivity.this, FetchAddressIntentService.class);
    ...
    public void onLocationChanged(Location location) {
        try {
            if (location != null)
                changeMap(location);
            LocationServices.FusedLocationApi.removeLocationUpdates(mGoogleApiClient, (com.google.android.gms.location.LocationListener) GoogleMapsActivity.this);
    ...
    public class AddressResultReceiver extends ResultReceiver {
        ...
        public void displayAddressOutput() {
            ...
            try {
                ...
                if (mAreaOutput == null) {
                    Toast.makeText(GoogleMapsActivity.this, "Cannot get Address", Toast.LENGTH_SHORT).show();
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
        ...
        try {
            ...
            if (requestCode == REQUEST_CODE_AUTOCOMPLETE) {
                if (resultCode == RESULT_OK) {
                    ...
                    if (ActivityCompat.checkSelfPermission(GoogleMapsActivity.this, android.Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                        // TODO: Consider calling
    ...
    public void checkNetworkConnection() {
        ...
        if (abUtil.isConnectingToInternet()) {
            ...
            Toast.makeText(GoogleMapsActivity.this, "Please check your internet connection", Toast.LENGTH_SHORT).show();
